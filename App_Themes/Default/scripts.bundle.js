...
function UpdateToggleStatus(s, e) {
    if ($("#m_aside_left_minimize_toggle").is(".m-brand__toggler--active")) {
        localStorage.setItem("MinimizeLeftSideBar", "1");
        $("#liSideBarLogo").attr("style", "display:none;top:28vh; aria-haspopup='true'");
    } else {
        localStorage.setItem("MinimizeLeftSideBar", "0");
        $("#liSideBarLogo").attr("style", "top:28vh; aria-haspopup='true'");
    }
}
$(document).ready(function() {
    //Expand Classes
    if (localStorage.getItem("MinimizeLeftSideBar") == "1") {
        $("#m_aside_left_minimize_toggle").click();
        $("#liSideBarLogo").attr("style", "display:none;top: calc(100% - 70px);position:absolute;");
    } else {
        $("#liSideBarLogo").attr("style", "top: calc(100% - 70px);position:absolute;");
    }
});